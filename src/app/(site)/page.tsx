...
export const metadata = {
  title: 'RootLab | Profesyonel Laboratuvar Analiz ve Belgelendirme Çözümleri',
      ...
      <HomeClient>
        ...
        <div className={`${styles.ctaSection} ${styles.reveal}`}>
          ...
          <div className={styles.ctaBtns}>
            ...
            <a href="https://wa.me/905401068640" className={styles.btnOutline} target="_blank" rel="noreferrer">WhatsApp ile Yaz</a>
          </div>
        </div>
      </HomeClient>
    </main>
