...
const generateAnalyses = (count) => {
  ...
  // Hardcoded specific highly professional bases
  const bases = [
...
export const services: Service[] = ${JSON.stringify(generateAnalyses(100), null, 2)};
export const blogs: BlogPost[] = ${JSON.stringify(generateBlogs(15), null, 2)};
export const categories = ${JSON.stringify(["Tümü", ...categories], null, 2)};
`;

fs.writeFileSync('src/data/mockData.ts', dataStr);
console.log('Veritabanı başarıyla 100 analiz ve 15 blog ile oluşturuldu!');
